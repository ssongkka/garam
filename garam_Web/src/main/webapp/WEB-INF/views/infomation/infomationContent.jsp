				...
				<div class="body-content-btn">
					...
					<div>
						<a class="BaseButton size_default BaseButton--skinGray"
							...
							value="${infomationContent.no}" />)">삭제</a>
						<a class="BaseButton size_default BaseButton--skinGray">수정</a>
					</div>
				</div>
			</div>
		</div>
